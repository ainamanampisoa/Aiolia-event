...
Dans cette interface,L'organisateur retrouve un tableau de bord sous forme de widgets, affichant la liste des codes promotionnels et offrant la possibilité de les filtrer.L'organisateur peut également créer une nouvelle code promo en définissant tous les paramètres nécessaires : type de réduction, dates de validité, limites d'utilisation et événements éligibles.

L'organisateur peut également consulter l'historique détaillé de l'utilisation de chaque promotion, supprimer celles qui sont expirées, ou modifier celles qui sont actives.
---
...
Cette interface permet à chacun d'adapter l'interface à ses préférences. On peut basculer instantanément entre le mode clair et le mode sombre, choisir une couleur d'accent pour personnaliser l'interface, et sélectionner sa langue — français ou anglais.
