...
class ReportController extends AbstractController
{
    ...
    public function rapports(Request $request): Response
    {
        ...
        // Normaliser les valeurs pour le template (convertir en string pour les comparaisons Twig)
        $month = $month ? trim((string) $month) : null;
        $year = $year ? trim((string) $year) : null;
