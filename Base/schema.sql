...
CREATE TABLE IF NOT EXISTS subscription_plans (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
    CONSTRAINT uq_subscription_plans_tier UNIQUE (tier, billing_period)
);

CREATE TABLE IF NOT EXISTS organizer_subscriptions (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    organizer_profile_id BIGINT NOT NULL REFERENCES organizer_profiles(id),
    plan_id BIGINT NOT NULL REFERENCES subscription_plans(id),
    -- Note: Les organisateurs peuvent choisir n'importe quel plan,
    -- indépendamment de leur organization_type (individual, company, non_profit, collective)
...
CREATE TABLE IF NOT EXISTS events (
    ...
    event_format event_format_enum NOT NULL DEFAULT 'in_person',
    capacity INTEGER CHECK (capacity IS NULL OR capacity >= 0),
    timezone VARCHAR(64) NOT NULL DEFAULT 'Indian/Antananarivo',
    ...
    CONSTRAINT fk_events_main_space
        FOREIGN KEY (venue_id, main_space_id)
        REFERENCES venue_spaces(venue_id, id)
);
...
CREATE INDEX IF NOT EXISTS idx_events_organizer ON events(organizer_profile_id, starts_at);
