...
CREATE TABLE IF NOT EXISTS users (
    ...
    login_method auth_provider_enum NOT NULL DEFAULT 'password',
    password_hash TEXT,
    ...
    auth_provider auth_provider_enum NOT NULL DEFAULT 'password',
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_users_login ON users (LOWER(login_identifier), login_method);
